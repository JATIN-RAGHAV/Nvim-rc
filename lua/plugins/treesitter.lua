...
return {
    ...
    config = function ()
        ...
        require'nvim-treesitter'.install {'lua', 'rust','go', 'javascript', 'typescript','jsx' ,'tsx','cpp','c','html','css','python','gomod','gosum','yaml','bash','zsh','caddy','dockerfile','nix','terraform','java','graphql','prisma'}:wait(30000)
